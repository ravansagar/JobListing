...
<div class="relative isolate overflow-hidden bg-gray-900 py-8 sm:py-8">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-4 max-w-2xl lg:mx-0 lg:max-w-none">
            <dl class="mt-4 grid grid-cols-1 gap-8 sm:mt-4 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="flex flex-col-reverse gap-1">
                    ...
                    <dd class="text-4xl font-semibold tracking-tight text-white">{{ $category }}+</dd>
                </div>
                <div class="flex flex-col-reverse gap-1">
